...
def load_dataset(data_dir, model_params, inference_mode=False):
  ...
  print(model_params.data_set)
    
  if isinstance(FLAGS.data_name, list):
    datasets = FLAGS.data_name
  else:
    datasets = [FLAGS.data_name]
# print(datasets)
  train_strokes = None
...
model_params.conditional = False
model_params.enc_model = 'lstm'
model_params.dec_model = 'hyper'
