...
class Decoder(nn.Module):
    ...
    def forward(self, Feature_father, P_father):
        ...
        left_P = self.sigmoid(out_father[:,self.n_feature:(self.n_feature + 3)])  # (n, 3)
        ...
        right_P = self.sigmoid(out_father[:,(self.n_feature * 2 + 4):(self.n_feature * 2 + 7)])  # (n, 3)
...
class AE(SaveableModule):
    ...
    def decode(self, X, Node_is_leaf, Feature, I_list):
        ...
        for i in range(num_I):
            ...
            X_ab_xy_r[I[:,0]] = out_p_left
            X_ab_xy_r[I[:,1]] = out_p_right

        return X, X_ab_xy_r, Feature, Loss_P, Loss_Leaf, num
