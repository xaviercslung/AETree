...
#                 print(i)
                ...
                # print(test_loader)
                # print('bug')
                # test = AE(device, leaf_loss=True, weight_leaf=0.01, weight_type=2, save_name='tree_lstm_32_print_45000_time_leaf_rerun2', n_feature=512)
                # print(test)
...
trainset = TreeData(data_folder="./data/Tree_2000_64_batch5.pickle", train=True, split=0.8, n_feature=512, num_box=64, batch_size=50)
train_loader = torch.utils.data.DataLoader(trainset, batch_size=1, shuffle=True)

testset = TreeData(data_folder="./data/Tree_2000_64_batch5.pickle", train=False, split=0.8, n_feature=512, num_box=64, batch_size=50)
